...
class main_screen():
    ...
    def add_button(self, coor, colour=(0, 0, 0), image = '', text='', text_colour =(255, 255, 255)):
        if image:
            ...
            sfc_button = pygame.Surface((coor[
                                        2], coor[3]))  # creamos superficie
            pygame.draw.rect(sfc_button, (100, 100, 100), (
                0, 0, coor[2], coor[3]), 3)  # recuadro
            txt_button = pygame.font.SysFont(
                None, coor[3] / 3)					# tipo texto boton
            sfc_button_txt = txt_button.render(
                text, True, text_colour)  # render texto boton
            large = sfc_button_txt.get_width()  # largo del texto
            self.buttons.append(sfc_button.blit(sfc_button_txt, ((coor[
                                2] - large) / 2, coor[3] / 3)))  # centramos el texto en el boton
